...
object VintageColors {
    ...
    /** Deep emerald - primary background (blackened green leather) */
    val EmeraldDeep = Color(0xFF011208)
    
    /** Dark emerald - card backgrounds */
    val EmeraldDark = Color(0xFF031E0E)
    
    /** Medium emerald - elevated surfaces */
    val EmeraldMedium = Color(0xFF053218)
    
    /** Light emerald - hover states */
    val EmeraldLight = Color(0xFF0A4028)
    ...
    val ProfitGreenBright = Color(0xFF00C853)
    ...
    val SurfaceOverlay = Color(0xE6031E0E)
    ...
    val GradientEmeraldMid = Color(0xFF061A0F)
    val GradientEmeraldEnd = Color(0xFF010E05)
...
object BasicColors {
    ...
    val Secondary = Color(0xFF2D6B4A)
