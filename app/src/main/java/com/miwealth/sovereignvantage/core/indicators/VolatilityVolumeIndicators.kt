...
/**
 * Typealias for backward compatibility — V5.17.0
 * AIBoardOrchestrator references VolatilityVolumeIndicators.atr() and .bollingerBands()
 */
typealias VolatilityVolumeIndicators = VolatilityIndicators
