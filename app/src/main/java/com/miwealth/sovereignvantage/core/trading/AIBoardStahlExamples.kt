...
fun exampleConstrainedSelection() {
    ...
    val context = MarketContext.build(indicators, hourUTC = 15)
...
fun exampleStairExpansionBorrow() {
    ...
    val context = MarketContext.build(indicators, hourUTC = 14)
...
fun exampleStairExpansionExtrapolate() {
    ...
    val context = MarketContext.build(indicators, hourUTC = 16, assetType = AssetType.CRYPTO)
...
fun exampleFullTradeLifecycle() {
    ...
    val entryContext = MarketContext.build(entryIndicators, hourUTC = 10)
    ...
    val expansionContext = MarketContext.build(expansionIndicators, hourUTC = 15)
...
fun exampleMarketScenarios() {
    ...
    val rangingContext = MarketContext.build(rangingMarket, hourUTC = 3)
    ...
    val newsContext = MarketContext.build(newsMarket, hourUTC = 14)
    ...
    val breakdownContext = MarketContext.build(breakdownMarket, hourUTC = 17)
    ...
    val compressionContext = MarketContext.build(compressionMarket, hourUTC = 13)
