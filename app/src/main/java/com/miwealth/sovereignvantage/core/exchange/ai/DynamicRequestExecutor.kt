...
class DynamicRequestExecutor(
    ...
    // V5.5.97: PQC integration (Gap 2) — forward PQC credentials to AI path
    ...
    private suspend fun executeRequest(
        ...
        // V5.5.97: PQC request signing (Gap 2) — sign ALL authenticated requests
        ...
        if (pqcRequestSigner != null && endpoint.authentication != AuthMethod.NONE) {
        ...
        // Execute — use PQC-secured HTTP client when available (V5.5.97)
...
// V5.5.97: Hex encoding extension — matches HybridSecureHttpClient.toHex() convention
