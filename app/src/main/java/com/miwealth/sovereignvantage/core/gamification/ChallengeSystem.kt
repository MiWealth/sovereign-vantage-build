...
data class DailyChallenge(
    ...
    val xpReward: Long,
    val endTime: Long,
    val difficulty: ChallengeDifficulty = ChallengeDifficulty.NORMAL
)
...
// Backward-compatible typealiases — V5.17.0
typealias DailyChallengeDuration = ChallengeDuration
typealias DailyChallengeDifficulty = ChallengeDifficulty
typealias Difficulty = ChallengeDifficulty
