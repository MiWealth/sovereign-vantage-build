...
abstract class BaseCEXConnector(
    ...
    // Rate limiting — V5.5.97: ArrayDeque for O(1) eviction (N3 optimisation, timestamps are monotonic)
    ...
    override fun isRateLimited(): Boolean {
        ...
        // Check rate limit window — V5.5.97: O(1) eviction since timestamps are monotonic
