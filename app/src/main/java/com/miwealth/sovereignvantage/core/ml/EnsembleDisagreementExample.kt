...
object EnsembleDisagreementExample {
    ...
    fun positionSizeAdjustment() {
        ...
        val scenarios = listOf(
            Triple("Strong Agreement", 0.75, 0.78, 0.80, 0.76),
            Triple("Mild Disagreement", 0.60, 0.75, 0.50, 0.65),
            Triple("Moderate Disagreement", 0.70, -0.30, 0.40, 0.50),
            Triple("High Disagreement", 0.80, -0.60, 0.20, -0.40),
            Triple("Extreme Disagreement", 0.90, -0.85, 0.10, -0.70)
        )
