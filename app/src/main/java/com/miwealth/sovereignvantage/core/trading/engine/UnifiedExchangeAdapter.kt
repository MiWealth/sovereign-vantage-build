 ...
 * - SmartOrderRouter compatible (V5.17.0)
 * 
...
class UnifiedExchangeAdapter(
     ...
     * V5.17.0: Now overrides RoutableExchangeAdapter for SmartOrderRouter compatibility.
     */
     ...
     * V5.17.0: Now overrides RoutableExchangeAdapter.
     ...
     * V5.17.0: RoutableExchangeAdapter implementation.
     */
