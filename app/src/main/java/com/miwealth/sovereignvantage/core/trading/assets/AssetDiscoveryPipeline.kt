...
class AssetDiscoveryPipeline(
    ...
    suspend fun runFromConnectionManager(
        ...
        val connectedExchanges = connectionManager.getExchangeIds().toList()
    ...
    private fun createTradableAsset(
        ...
        // Convert data.models.AssetCategory to core.trading.assets.AssetCategory by name
        val inferredTradingCategory = try {
            AssetCategory.valueOf(riskProfile.inferredCategory.name)
        } catch (e: IllegalArgumentException) {
            AssetCategory.MAJOR_CRYPTO
        }
        val category = mapToAssetCategory(asset.category, inferredTradingCategory)
        ...
        return TradableAsset(
            ...
            minOrderSize = java.math.BigDecimal("0.00001"),
            tickSize = java.math.BigDecimal("0.00000001"),
            lotSize = java.math.BigDecimal("0.00001"),
            maxLeverage = riskProfile.recommendedLeverage.toInt(),
    ...
    private fun mapToAssetCategory(
        ...
        when (enrichedCategory?.lowercase()) {
            ...
            "chain", "layer1", "layer-1" -> return AssetCategory.ALT_LAYER1
            "layer2", "layer-2" -> return AssetCategory.LAYER2
            "meme", "memes" -> return AssetCategory.MEME
            "gaming" -> return AssetCategory.NFT_GAMING
            "nft" -> return AssetCategory.NFT_GAMING
            "ai" -> return AssetCategory.AI_CRYPTO
            "privacy" -> return AssetCategory.PRIVACY
            "exchange" -> return AssetCategory.EXCHANGE_TOKENS
        }
