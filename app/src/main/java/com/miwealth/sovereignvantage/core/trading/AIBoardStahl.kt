...
data class MarketContext(
    ...
    companion object {
        /**
         * Build MarketContext from raw indicator values.
         */
        fun build(indicators: IndicatorSnapshot, hourUTC: Int, assetType: AssetType = AssetType.CRYPTO): MarketContext {
...
/**
 * Asset type classification for context.
 */
...
class AIBoardStahlSelector(
     ...
     */
    fun recommendPreset(context: MarketContext): PresetRecommendation {
     ...
     */
    private fun calculatePresetScores(context: MarketContext): Map<StahlPreset, Double> {
     ...
     */
    private fun calculateConservativeScore(context: MarketContext): Double {
     ...
     */
    private fun calculateModerateScore(context: MarketContext): Double {
     ...
     */
    private fun calculateAggressiveScore(context: MarketContext): Double {
        var score = 0.5  // Base score
     ...
     */
    private fun calculateScalpingScore(context: MarketContext): Double {
     ...
     */
    private fun summarizeConditions(context: MarketContext): String {
...
class AIBoardStairExpander(
   ...
   640	        private const val LOCK_IN_RATIO = 0.80
     ...
     */
    private fun evaluateMomentumForExpansion(context: MarketContext): Boolean {
     ...
     */
    private fun calculateATRBasedSpacing(context: MarketContext): Double {
