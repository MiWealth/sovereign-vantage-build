...
class ElasticWeightConsolidation(
     ...
     * V5.5.80: Replaced finite-difference approximation with analytical gradients
        ...
        return weights.weights.mapIndexed { index, _ ->
            ...
            val feature = when {
                index < 6 -> when(index) {
                    ...
                    1 -> example.features.volume / 1000000.0
     ...
     * V5.5.80: Added to expose analytical gradients to continual learning
     */
...
class ContinualLearningManager(
     ...
     * V5.5.80: Fixed to use actual gradients instead of random noise
     */
    fun trainOnNewTask(
        taskId: String,
        ...
        newData.forEach { example ->
            ...
            // V5.5.80: Previously used Random.nextDouble() - pure noise!
