 ...
 * 
 * V5.5.78: Unified enum merging base + AI exchange types.
...
data class TradingPair(
    ...
    val quantityStep: Double,        // Lot size increment
    val minPrice: Double,
    val maxPrice: Double,
    val priceStep: Double,           // Tick size
    val minNotional: Double,         // Minimum order value
