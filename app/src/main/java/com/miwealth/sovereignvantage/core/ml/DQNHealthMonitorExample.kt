 ...
 * V5.5.88: Shows how to wire health monitoring into existing trading pipeline
 *
...
class MonitoredDQNTrader {
    ...
    fun initialise() {
        ...
        println("✅ Pretrained: ${stats.finalWinRate}% win rate over ${stats.totalEpisodes} episodes")
 ...
 * class DQNTrader(...) {
 *
 *     // V5.5.88: Expose policy network for health monitoring
 *     fun getPolicyNetwork(): SimpleNeuralNetwork = policyNetwork
 *
 *     // V5.5.88: Replay with health monitoring
